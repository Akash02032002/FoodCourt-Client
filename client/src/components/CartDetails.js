...
const CartDetails = () => {
    ...
    const makePayment = async()=>{
        const stripe = await loadStripe("pk_test_51Np59ySA55KCzQFWS8T8VLQxLd2gNEypzMuxrD1NUcyRClfxUPX9ChMHgtErLwRu3A4GmmsqwhyDJr1uaeVNPJNn00O8UPqfWg");
        ...
        const response = await fetch("https://foodcourt-server.onrender.com/api/create-checkout-session",{
            method:"POST",
            headers:headers,
